        ...
        <div class="row">
          <div class="col-12">
            <!-- Default box -->
              ...
              <h2>Selamat datang dan mencoba di perhitungan kalkulator BMI, ayoo coba masukan data anda!! </h2>
            ...
            <form method="POST">
              ...
              <div class="form-group row">
                <label for="tanggal" class="col-4 col-form-label">Tanggal/Bulan/Tahun</label> 
                <div class="col-8">
                  <div class="input-group">
                    ...
                    <input id="tanggal" name="tanggal" placeholder="Masukan Tanggal/Bulan/Tahun" type="text" class="form-control">
                  </div>
                </div>
              </div> 
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-8">
                  <input id="berat" name="berat" placeholder="Masukan berat badan anda" type="text" class="form-control" aria-describedby="beratHelpBlock"> 
              ...
              <div class="form-group row">
                ...
                <div class="col-8">
                  <input id="tinggi" name="tinggi" placeholder="Masukan tinggi anda" type="text" class="form-control" aria-describedby="tinggiHelpBlock"> 
